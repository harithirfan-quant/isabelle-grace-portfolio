  ...
  return (
    <section id="press" className="container scroll-mt-20 py-24">
      <SectionHeading
        ...
        description="Media mentions, roughly newest first. Source links land here as coverage is confirmed."
      />
          ...
          return (
            <Reveal key={item.url + i} delay={(i % 3) * 0.05}>
              {hasUrl ? (
                ...
                <div className="group flex h-full flex-col border-2 border-foreground/15 bg-card">
                  {body}
                </div>
              )}
            </Reveal>
